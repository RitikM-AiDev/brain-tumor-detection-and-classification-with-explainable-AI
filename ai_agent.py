...
def explainable_ai(state : State):
    ...
    SystemMessage(
        ...
        REPORT STRUCTURE:
        1. LOCATION: Describe the specific area where the mass is situated and locate the mass like it is in center or left to or right to something.
        2. SHAPE/APPEARANCE: Describe the visual form and brightness of the mass.
        3. STRUCTURAL IMPACT: Mention how the mass affects the surrounding brain areas.
...
current_state = {"messages" : [] , "img" : converted_img , "type_img" : "pituitary" , "summary" : ""}
